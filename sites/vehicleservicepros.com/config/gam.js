...
config
  ...
  .setAliasAdUnits('product-guide/tools/adas-calibration-and-programming', [
  ...
  .setAliasAdUnits('product-guide/tools/air-conditioning-a-c-service-and-repair', [
  ...
  .setAliasAdUnits('product-guide/tools/air-tools', [
  ...
  .setAliasAdUnits('product-guide/tools/body-shop-and-repair', [
  ...
  .setAliasAdUnits('product-guide/tools/brake-service-and-tools', [
  ...
  .setAliasAdUnits('product-guide/tools/chemicals', [
  ...
  .setAliasAdUnits('product-guide/tools/computers-and-tablets', [
  ...
  .setAliasAdUnits('product-guide/tools/cordless-tools', [
  ...
  .setAliasAdUnits('product-guide/tools/diagnostic-test-equipment', [
  ...
  .setAliasAdUnits('product-guide/tools/electrical-system-tools-equipment', [
  ...
  .setAliasAdUnits('product-guide/tools/emissions-system-tools', [
  ...
  .setAliasAdUnits('product-guide/tools/engine-service-and-repair-tools', [
  ...
  .setAliasAdUnits('product-guide/tools/hand-tools', [
  ...
  .setAliasAdUnits('product-guide/tools/hybrid-and-ev-service-and-repairs', [
  ...
  .setAliasAdUnits('product-guide/tools/inspection-tools', [
  ...
  .setAliasAdUnits('product-guide/tools/leak-detection', [
  ...
  .setAliasAdUnits('product-guide/tools/lighting', [
  ...
  .setAliasAdUnits('product-guide/tools/repair-information-sources', [
  ...
  .setAliasAdUnits('product-guide/tools/safety-equipment-personal-gear', [
  ...
  .setAliasAdUnits('product-guide/tools/scan-tools-and-scan-tool-accessories', [
  ...
  .setAliasAdUnits('product-guide/tools/shop-management-and-point-of-sale', [
  ...
  .setAliasAdUnits('product-guide/tools/specialty-tools', [
  ...
  .setAliasAdUnits('product-guide/tools/suspension-and-steering-service-tools', [
  ...
  .setAliasAdUnits('product-guide/tools/tire-and-wheel-service-small-tools', [
  ...
  .setAliasAdUnits('product-guide/tools/tool-accessories', [
  ...
  .setAliasAdUnits('product-guide/tools/welding-equipment', [
  ...
  .setAliasAdUnits('product-guide/tools/top-100-most-wanted-products', [
  ...
  .setAliasAdUnits('product-guide/equipment/compressed-air-systems', [
  ...
  .setAliasAdUnits('product-guide/equipment/lifts-and-lifting-equipment', [
  ...
  .setAliasAdUnits('product-guide/equipment/jacks-stands-and-hoists', [
  ...
  .setAliasAdUnits('product-guide/equipment/oil-lube-and-fluid-equipment', [
  ...
  .setAliasAdUnits('product-guide/equipment/painting-and-refinish', [
  ...
  .setAliasAdUnits('product-guide/equipment/shop-equipment', [
  ...
  .setAliasAdUnits('product-guide/equipment/tire-and-wheel-large-equipment', [
  ...
  .setAliasAdUnits('product-guide/equipment/tool-storage', [
  ...
  .setAliasAdUnits('product-guide/parts/battery-starting-charging-systems', [
  ...
  .setAliasAdUnits('product-guide/parts/chassis-suspension-steering', [
  ...
  .setAliasAdUnits('product-guide/parts/engine-and-powertrain', [
  ...
  .setAliasAdUnits('product-guide/parts/hybrid-and-ev-service-and-repairs', [
  ...
  .setAliasAdUnits('product-guide/parts/general-service', [
  ...
  .setAliasAdUnits('product-guide/parts/hvac', [
  ...
  .setAliasAdUnits('product-guide/training/ase-study-and-training-products', [
  ...
  .setAliasAdUnits('product-guide/training/training-products-and-tools', [
